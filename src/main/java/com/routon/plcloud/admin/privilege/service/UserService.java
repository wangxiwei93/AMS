...
public interface UserService {
	 ...
	 * @return 存在返回true，反之返回false
	 */
	public boolean phoneExist(String username);
	...
	public Long save(User user,String realName,String idcard,  String phone,
			String companynames, String department, String roleIds, String projectIds , UserProfile optUser);

	public Long edit( Integer updateId, String realName, String idcard,
			String phone, String companynames, String department, String roleIds,String projectIds , UserProfile optUser);
