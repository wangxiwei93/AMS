...
<%@ include file="/WEB-INF/views/head_n.jsp" %>
	...
	<div class="panel panel-default">
		...
		<display:table name="requestScope.pageList" id="curPage" class="table table-striped" sort="external"
			...
			<display:column title="操作时间"  property="time"  sortable="true"  style="width:12%;" decorator="com.routon.plcloud.common.decorator.PageDateTimeDecorator"></display:column>
			<display:column title="用户名"  property="userName"  sortable="true"  style="width:12%;" decorator="com.routon.plcloud.common.decorator.PageDateTimeDecorator"></display:column>
			<display:column title="姓名"  property="realName" sortable="true"  style="width:12%;" decorator="com.routon.plcloud.common.decorator.PageDateTimeDecorator"></display:column>
