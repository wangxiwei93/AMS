...
<%@ include file="/WEB-INF/views/head_n.jsp" %>
	...
	<div class="panel panel-default" style="width: 1560px;">
		...
		<display:table name="requestScope.pageList" id="curPage" class="table table-striped" sort="external"
			...
			<display:column title="上报时间"  property="time" sortable="true"  style="width:10%;" decorator="com.routon.plcloud.common.decorator.PageDateTimeDecorator" ></display:column>
		</display:table>
	</div>
	...
	<!-- <iframe id="test_frame" frameborder="0" scrolling="yes" name="main" src="http://172.16.42.134:8080/plcloud/v2/facecompare1v1Test.do" style=" height:500px; visibility: inherit; width: 100%; z-index: 1;overflow: visible;"></iframe> -->
