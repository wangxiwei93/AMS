...
<body>
<img id="bg" src="${ctx}/images/bg.png" width="100%" height="100%" style="right: 0; bottom: 0;position: absolute; top: 0; left: 0; z-index: -1" /> 

	<div class="container" style="width: 970px;height: 239px; margin-top: 20px;">
	</div>	
	
	<div class="container" style="width: 420px;height: 430px; background-image: url('${ctx}/images/login_modal.png');background-repeat: no-repeat;padding-right:0px;margin-left: 1300px;padding-left: 10px;">
  		<div class="container" style=" width: 420px;height: 51px; background-image: url('${ctx}/images/login_title.png');background-repeat: no-repeat;padding-right:0px;margin-left: 0px;padding-left: 0px;margin-top: 5px;" >
  		<div class="container" style="width: 400px;padding-left: 0px;padding-right: 0px;margin-top: 120px;margin-left: 0px;">
		<form:form commandName="user" cssClass="form-horizontal " role="form" method="post" action="${ctx}/login/authen.do" onsubmit="return validator(this)" >
		  ...
		  <div class="container"style="width: 353px;margin-top: 20px;padding-left: 0px;padding-right:0px;">
		      <button id="savebtn" name="savebtn" type="submit" class="btn btn-info btn-lg " style="width: 100%;color: white;font-family: 微软雅黑;font-size: 20px;background-image: url('${ctx}/images/login_submit.png');background-repeat: no-repeat;">登录</button>
		  </div>
		</form:form>
	  </div>
	</div>
