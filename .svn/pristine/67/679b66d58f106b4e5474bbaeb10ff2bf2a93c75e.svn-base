...
<!-- 			  </div> -->
			  ...
			  <div class="form-group">
			    <label for="title" class="col-sm-2 control-label">身份证号</label>
			    <div class="col-sm-4">
			      <input type="text" class="form-control" id="idcard" name="idcard" placeholder="身份证号码" value="${user.idcard}">
			    </div>
			  </div>
...
<%-- 			  <div class="form-group">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-4">
			      <input type="text" class="form-control" id="department" name="department" placeholder="部门" value="${user.department}">
			    </div>
			  </div>
<!-- 			  <div class="form-group"> -->
<!-- 			    <label for="project" class="col-sm-2 control-label">项目名称</label> -->
