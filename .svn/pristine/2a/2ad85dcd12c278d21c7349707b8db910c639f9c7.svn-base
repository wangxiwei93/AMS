...
//	@Length(min=1, max=20,message="用户登录名长度为1-12")
...
//	@NotEmpty(message="请至少选择一个项目名称")
	...
	public String getProject_texts() {
		return project_texts;
	}

	public void setProject_texts(String project_texts) {
		this.project_texts = project_texts;
	}
